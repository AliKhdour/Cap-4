...
public class AccountController {
    ...
    @RequestMapping(path = "/newprofile", method = RequestMethod.POST)
    public String newProfile(@RequestBody Profile newProfile) {
    	System.out.println("profile called");
    	
    	Profile aProfile = profileDAO.createProfile(newProfile);
