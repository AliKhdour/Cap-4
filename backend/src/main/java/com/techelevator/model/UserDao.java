...
public interface UserDao {
    ...
    public User saveUser(String username, String password, String role); //switch to email
     ...
     */
    public User getValidUserWithPassword(String username, String password); //switch UN to email
